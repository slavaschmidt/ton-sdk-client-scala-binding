...
object Crypto {
  ...
  implicit val registerEncryptionBox           = new SdkCall[Request.RegisterAppEncryptionBox, RegisteredEncryptionBox] { override val function: String = s"$module.register_encryption_box"               }
  ...
  implicit val encryptionBoxDecrypt            = new SdkCall[Request.EncryptionBoxEncrypt, Result.EncryptionBoxEncrypt] { override val function: String = s"$module.encryption_box_decrypt"                }
}
